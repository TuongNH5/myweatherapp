...
import 'package:myweatherapp/presentation/screen/widget/weather_item.dart';
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height: Dimens.getProportionalScreenHeight(context, 116),
                child: Image.asset(AppColors.pathIconWeather()),
              ),
              Row(
